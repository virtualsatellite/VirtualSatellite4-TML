...
public class CppTasking3TaskDefinitionTemplate extends CppTaskDefinitionTemplate {
  public CppTasking3TaskDefinitionTemplate(final TaskingEnvironment taskingEnvironment, final TaskDefinition taskDefinition) {
  ...
  public CharSequence getConstructorArgs() {
    ...
    _builder.append("Tasking::Scheduler& ");
    _builder.append(this.SCHEDULER_PARAM_NAME);
    _builder.append(",");
    _builder.newLineIfNotEmpty();
    {
      EnumSchedulePolicy _schedulePolicy = this.taskDefinition.getSchedulePolicy();
      boolean _equals = Objects.equal(_schedulePolicy, EnumSchedulePolicy.PRIORITY);
      if (_equals) {
        _builder.append("unsigned int ");
        _builder.append(this.PRIORITY_PARAM_NAME);
        _builder.append(",");
      }
    }
    _builder.newLineIfNotEmpty();
  ...
  public String compileAbstractHeader() {
    StringConcatenation _builder = new StringConcatenation();
    String _generationAbstractHeaderDescription = this.getGenerationAbstractHeaderDescription("CppTasking3TaskDefinitionTemplate.xtend");
    ...
    _builder.append(_abstractName, "\t");
    {
      ...
      if (_isTask) {
        _builder.append(": public Tasking::TaskProvider<");
    ...
    _builder.append("\t");
    _builder.append("Tasking::TaskInput getInput(unsigned int);");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
  ...
  public String compileAbstractSource() {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      if (_isTask) {
        _builder.append("\t");
        _builder.append("Tasking::TaskProvider(");
        _builder.append(this.SCHEDULER_PARAM_NAME, "\t");
        _builder.append(", ");
        {
          EnumSchedulePolicy _schedulePolicy = this.taskDefinition.getSchedulePolicy();
          boolean _equals = Objects.equal(_schedulePolicy, EnumSchedulePolicy.PRIORITY);
          if (_equals) {
            _builder.append("Tasking::SchedulePolicyPriority::Settings(");
            _builder.append(this.PRIORITY_PARAM_NAME, "\t");
            _builder.append(")");
          }
        }
    ...
    _builder.append("::");
    String _abstractName_8 = this.getAbstractName(this.taskDefinition.getName());
    _builder.append(_abstractName_8);
    _builder.append("::getInput(unsigned int key) {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("return inputs[key];");
    _builder.newLine();
    _builder.append("}\t\t");
    _builder.newLine();
    return _builder.toString();
  ...
  public String compileHeader() {
    StringConcatenation _builder = new StringConcatenation();
    String _generationHeaderDescription = this.getGenerationHeaderDescription("CppTasking3TaskDefinitionTemplate.xtend");
