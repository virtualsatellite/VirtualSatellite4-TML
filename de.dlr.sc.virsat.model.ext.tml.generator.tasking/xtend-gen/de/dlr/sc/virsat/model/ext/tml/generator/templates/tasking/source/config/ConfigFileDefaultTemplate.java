...
public class ConfigFileDefaultTemplate extends AbstractConfigFileTemplate implements IConfigFileTemplate {
  ...
  public ConfigFileDefaultTemplate(final TaskingEnvironment taskingEnvironment) {
  ...
  public String compileFileContent() {
    ...
    _builder.newLine();
    _builder.newLine();
    String _printConfiguration = this.printConfiguration(this.taskingEnvironment.getName(), this.taskingEnvironment.getGlobalParameters(), false);
    ...
    _builder.newLine();
    {
      ...
      for(final TaskInstance task : _tasks) {
        String _printConfiguration_1 = this.printConfiguration(this.getClassName(task.getName()), task.getTypeOf().getParameters(), false);
