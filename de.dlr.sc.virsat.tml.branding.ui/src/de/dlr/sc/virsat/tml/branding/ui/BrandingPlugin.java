 ...
 *******************************************************************************/
package de.dlr.sc.virsat.tml.branding.ui;
...
public class BrandingPlugin extends AbstractUIPlugin implements IStartup {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "de.dlr.sc.virsat.tml.branding.ui"; //$NON-NLS-1$
		...
		if (switchPerpective) {
	        ...
	        new UIJob("Switching to default perspectives") {
	            ...
	            public IStatus runInUIThread(IProgressMonitor monitor) {
	                try {
	                    workbench.showPerspective("de.dlr.sc.virsat.tml.branding.ui.default.perspective", workbench.getActiveWorkbenchWindow());
