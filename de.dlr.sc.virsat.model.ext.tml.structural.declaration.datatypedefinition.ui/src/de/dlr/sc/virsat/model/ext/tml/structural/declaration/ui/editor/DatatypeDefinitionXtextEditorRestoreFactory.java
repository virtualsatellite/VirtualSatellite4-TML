 ...
 *
 */
public class DatatypeDefinitionXtextEditorRestoreFactory implements IElementFactory {

	public static final String FACTORY_ID = "de.dlr.sc.virsat.model.ext.tml.structural.declaration.ui.editor.DatatypeDefinitionXtextEditorRestoreFactory";

	@Override
	public IAdaptable createElement(IMemento memento) {
		String uriString = memento.getString(DatatypeDefinitionEditorInput.MEMENTO_ID_URI);
		...
		IEditorInput editorInput = new DatatypeDefinitionEditorInput(file, platformUri, null, null);
