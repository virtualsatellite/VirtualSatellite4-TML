...
class DatatypeDefinitionUiModule extends AbstractDatatypeDefinitionUiModule {
	
	override bindIResourceForEditorInputFactory() {
		ResourceUtil.registerDMFResourceFactory();
		return VirsatCategoryResourceForEditorInputFactory
	}
	
	// the normal Xtext activator classes to not have such capabilities.
	public static final Logger LOGGER = Logger.getLogger(DatatypeDefinitionUiModule);
