 ...
 * 
 */	
public abstract class AAddTMLConfigurationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTMLConfigurationCommand().create(editingDomain, owner, activeConcept);
	}
}
