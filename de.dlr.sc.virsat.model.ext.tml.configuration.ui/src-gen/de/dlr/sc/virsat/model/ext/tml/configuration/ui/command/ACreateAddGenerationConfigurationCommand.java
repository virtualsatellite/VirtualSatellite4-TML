...
import de.dlr.sc.virsat.model.ext.tml.configuration.model.GenerationConfiguration;
 ...
 * 
 */	
public abstract class ACreateAddGenerationConfigurationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		GenerationConfiguration conceptObject = new GenerationConfiguration(activeConcept);
