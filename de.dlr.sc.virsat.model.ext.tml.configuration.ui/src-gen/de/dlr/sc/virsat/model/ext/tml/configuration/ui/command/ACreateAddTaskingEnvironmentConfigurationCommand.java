...
import de.dlr.sc.virsat.model.ext.tml.configuration.model.TaskingEnvironmentConfiguration;
 ...
 * 
 */	
public abstract class ACreateAddTaskingEnvironmentConfigurationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		TaskingEnvironmentConfiguration conceptObject = new TaskingEnvironmentConfiguration(activeConcept);
