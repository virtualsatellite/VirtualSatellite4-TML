...
import de.dlr.sc.virsat.model.ext.tml.configuration.model.ElementConfiguration;
 ...
 * 
 */	
public abstract class ACreateAddElementConfigurationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ElementConfiguration conceptObject = new ElementConfiguration(activeConcept);
