...
public class EnumDefinitionXtextEditorRestoreFactory implements IElementFactory {
	...
	public IAdaptable createElement(IMemento memento) {
		String uriString = memento.getString(EnumDefinitionEditorInput.MEMENTO_ID_URI);
		...
		IEditorInput editorInput = new EnumDefinitionEditorInput(file, platformUri, null, null);
