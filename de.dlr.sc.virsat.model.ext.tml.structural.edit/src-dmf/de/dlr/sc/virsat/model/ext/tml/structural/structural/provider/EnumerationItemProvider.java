...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.ext.tml.structural.structural.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Enumeration_serializedDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_serializedDefinition_feature", "_UI_Enumeration_type"),
				 StructuralPackage.Literals.ENUMERATION__SERIALIZED_DEFINITION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructuralPackage.Literals.ENUMERATION__LITERALS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructuralPackage.Literals.ENUMERATION__LITERALS,
				 StructuralFactory.eINSTANCE.createEnumerationLiteral()));
	}
