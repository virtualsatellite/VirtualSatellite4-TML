...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.ext.tml.structural.structural.TimeEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeEventItemProvider 
	extends IEventSourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeEvent_period_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeEvent_period_feature", "_UI_TimeEvent_type"),
				 StructuralPackage.Literals.TIME_EVENT__PERIOD,
				 true,
				 false,
				 false,
	...
	protected void addOffsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeEvent_offset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeEvent_offset_feature", "_UI_TimeEvent_type"),
				 StructuralPackage.Literals.TIME_EVENT__OFFSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TimeEvent.class)) {
			case StructuralPackage.TIME_EVENT__PERIOD:
			case StructuralPackage.TIME_EVENT__OFFSET:
