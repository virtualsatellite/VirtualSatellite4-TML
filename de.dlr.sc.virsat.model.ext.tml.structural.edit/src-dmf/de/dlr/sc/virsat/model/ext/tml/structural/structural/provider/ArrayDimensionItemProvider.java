...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.ext.tml.structural.structural.ArrayDimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayDimensionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructuralPackage.Literals.ARRAY_DIMENSION__SIZE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ArrayDimension)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ArrayDimension_type") :
			getString("_UI_ArrayDimension_type") + " " + label;
	}
