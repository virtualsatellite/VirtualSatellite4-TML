...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.ext.tml.structural.structural.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_dataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_dataType_feature", "_UI_Channel_type"),
				 StructuralPackage.Literals.CHANNEL__DATA_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructuralPackage.Literals.CHANNEL__CHANNEL_BEHAVIOR);
		}
