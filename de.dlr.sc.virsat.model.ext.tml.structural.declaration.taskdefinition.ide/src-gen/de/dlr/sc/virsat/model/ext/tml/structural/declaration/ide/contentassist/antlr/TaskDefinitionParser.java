...
import de.dlr.sc.virsat.model.ext.tml.structural.declaration.ide.contentassist.antlr.internal.InternalTaskDefinitionParser;
...
public class TaskDefinitionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(TaskDefinitionGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TaskDefinitionGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAttributeAccess().getAlternatives_5(), "rule__Attribute__Alternatives_5");
			builder.put(grammarAccess.getEStringAccess().getAlternatives(), "rule__EString__Alternatives");
			builder.put(grammarAccess.getTaskDefinitionAccess().getGroup_0(), "rule__TaskDefinition__Group_0__0");
			builder.put(grammarAccess.getTaskDefinitionAccess().getGroup_0_3(), "rule__TaskDefinition__Group_0_3__0");
			builder.put(grammarAccess.getTaskDefinitionAccess().getGroup_1(), "rule__TaskDefinition__Group_1__0");
			builder.put(grammarAccess.getTaskDefinitionAccess().getGroup_2(), "rule__TaskDefinition__Group_2__0");
			builder.put(grammarAccess.getTaskDefinitionAccess().getGroup_2_0(), "rule__TaskDefinition__Group_2_0__0");
			builder.put(grammarAccess.getTaskInputDefinitionAccess().getGroup(), "rule__TaskInputDefinition__Group__0");
			builder.put(grammarAccess.getTaskInputDefinitionAccess().getGroup_1(), "rule__TaskInputDefinition__Group_1__0");
			builder.put(grammarAccess.getTaskOutputDefinitionAccess().getGroup(), "rule__TaskOutputDefinition__Group__0");
			builder.put(grammarAccess.getTaskOutputDefinitionAccess().getGroup_1(), "rule__TaskOutputDefinition__Group_1__0");
			...
			builder.put(grammarAccess.getTaskDefinitionAccess().getNameAssignment_0_1(), "rule__TaskDefinition__NameAssignment_0_1");
			builder.put(grammarAccess.getTaskDefinitionAccess().getInputsAssignment_0_3_2(), "rule__TaskDefinition__InputsAssignment_0_3_2");
			builder.put(grammarAccess.getTaskDefinitionAccess().getOutputsAssignment_1_2(), "rule__TaskDefinition__OutputsAssignment_1_2");
			builder.put(grammarAccess.getTaskDefinitionAccess().getParametersAssignment_2_0_2(), "rule__TaskDefinition__ParametersAssignment_2_0_2");
			builder.put(grammarAccess.getTaskInputDefinitionAccess().getNameAssignment_0(), "rule__TaskInputDefinition__NameAssignment_0");
			builder.put(grammarAccess.getTaskInputDefinitionAccess().getDataTypeAssignment_1_1(), "rule__TaskInputDefinition__DataTypeAssignment_1_1");
			builder.put(grammarAccess.getTaskOutputDefinitionAccess().getNameAssignment_0(), "rule__TaskOutputDefinition__NameAssignment_0");
			builder.put(grammarAccess.getTaskOutputDefinitionAccess().getDataTypeAssignment_1_1(), "rule__TaskOutputDefinition__DataTypeAssignment_1_1");
			...
			builder.put(grammarAccess.getTaskDefinitionAccess().getUnorderedGroup(), "rule__TaskDefinition__UnorderedGroup");
	...
	@Override
	protected InternalTaskDefinitionParser createParser() {
		InternalTaskDefinitionParser result = new InternalTaskDefinitionParser(null);
