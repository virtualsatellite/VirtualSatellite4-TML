 ...
 * 
 */	
public abstract class ACreateAddBehavioralParameterDefinitionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		BehavioralParameterDefinition conceptObject = new BehavioralParameterDefinition(activeConcept);
