 ...
 * 
 */	
public abstract class AAddChannelBehaviorDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddChannelBehaviorDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
