 ...
 * 
 */	
public abstract class AUiSnippetTableBehavioralParameterDefinition extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableBehavioralParameterDefinition() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddBehavioralParameterDefinitionCommand().create(editingDomain, model, activeConcept);
	}
}
