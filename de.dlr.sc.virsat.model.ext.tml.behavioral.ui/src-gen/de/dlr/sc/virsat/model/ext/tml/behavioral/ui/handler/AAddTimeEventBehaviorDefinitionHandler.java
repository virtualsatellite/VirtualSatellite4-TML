 ...
 * 
 */	
public abstract class AAddTimeEventBehaviorDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTimeEventBehaviorDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
