...
public abstract class AUiSnippetTableChannelBehaviorParameterInstancesBehaviorParameter extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementParameterInstancesCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "BehaviorParameter"));
	}
}
