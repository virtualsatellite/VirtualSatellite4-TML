 ...
 * 
 */	
public abstract class AAddTaskBehaviorHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskBehaviorCommand().create(editingDomain, owner, activeConcept);
	}
}
