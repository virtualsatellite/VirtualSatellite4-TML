...
import de.dlr.sc.virsat.model.ext.tml.behavioral.model.BehaviorDefintionStorage;
 ...
 * 
 */	
public abstract class ACreateAddBehaviorDefintionStorageCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		BehaviorDefintionStorage conceptObject = new BehaviorDefintionStorage(activeConcept);
