 ...
 * 
 */	
public abstract class AUiSnippetTableBehaviorParameter extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableBehaviorParameter() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddBehaviorParameterCommand().create(editingDomain, model, activeConcept);
	}
}
