 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.ext.tml.behavioral.ui.command;
...
import de.dlr.sc.virsat.model.ext.tml.behavioral.model.TimeEventBehaviorDefinition;
 ...
 * 
 */	
public abstract class ACreateAddTimeEventBehaviorDefinitionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		TimeEventBehaviorDefinition conceptObject = new TimeEventBehaviorDefinition(activeConcept);
