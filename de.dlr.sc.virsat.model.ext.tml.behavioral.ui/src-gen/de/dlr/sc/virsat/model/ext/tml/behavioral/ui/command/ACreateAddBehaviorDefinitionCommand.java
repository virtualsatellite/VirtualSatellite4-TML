...
import de.dlr.sc.virsat.model.ext.tml.behavioral.model.BehaviorDefinition;
 ...
 * 
 */	
public abstract class ACreateAddBehaviorDefinitionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		BehaviorDefinition conceptObject = new BehaviorDefinition(activeConcept);
