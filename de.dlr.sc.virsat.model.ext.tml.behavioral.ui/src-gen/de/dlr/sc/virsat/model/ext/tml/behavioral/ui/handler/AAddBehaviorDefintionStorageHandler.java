 ...
 * 
 */	
public abstract class AAddBehaviorDefintionStorageHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddBehaviorDefintionStorageCommand().create(editingDomain, owner, activeConcept);
	}
}
