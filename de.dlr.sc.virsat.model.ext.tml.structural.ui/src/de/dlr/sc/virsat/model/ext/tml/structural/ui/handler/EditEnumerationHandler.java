...
import de.dlr.sc.virsat.model.ext.tml.structural.declaration.ui.editor.EnumDefinitionEditor;
...
import de.dlr.sc.virsat.model.ext.tml.structural.model.Enumeration;
 ...
 * 
 */
public class EditEnumerationHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		CategoryAssignment categorySubject = getSubjectCAssignment(selectionHelper.getFirstEObject());
	...
	protected static void openXtextEditor(CategoryAssignment containerCatergoryAssignment,
		...
		EnumDefinitionEditorInput editorInput = createEditorInput(containerCatergoryAssignment,
	 ...
	 * @return editor input
	 */
	protected static EnumDefinitionEditorInput createEditorInput(CategoryAssignment containerCatergoryAssignment,
			CategoryAssignment subjectCatergoryAssignment) {
		...
		return new EnumDefinitionEditorInput(file, resourceAndEObjectUri, containerCatergoryAssignment,
				subjectCatergoryAssignment);
	}
	...
	public boolean isEnabled() {
		...
		if (selectionHelper.getFirstEObject() instanceof ComposedPropertyInstance) {
			...
			return property.getType().getName().equals(ATaskingDefinition.PROPERTY_ENUMERATIONS);
		}
		...
		if (selectionHelper.getFirstEObject() instanceof CategoryAssignment) {
			...
			return categoryA.getType().getFullQualifiedName().equals(Enumeration.FULL_QUALIFIED_CATEGORY_NAME);
		}
	 ...
	 * @return the enumeration as category assignment
	 */
	protected CategoryAssignment getSubjectCAssignment(EObject selection) {
