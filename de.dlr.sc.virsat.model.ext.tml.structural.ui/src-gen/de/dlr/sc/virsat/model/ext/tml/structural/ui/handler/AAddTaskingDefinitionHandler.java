 ...
 * 
 */	
public abstract class AAddTaskingDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskingDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
