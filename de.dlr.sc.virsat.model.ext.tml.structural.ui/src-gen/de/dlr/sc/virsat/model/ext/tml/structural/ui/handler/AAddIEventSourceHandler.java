 ...
 * 
 */	
public abstract class AAddIEventSourceHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddIEventSourceCommand().create(editingDomain, owner, activeConcept);
	}
}
