...
import de.dlr.sc.virsat.model.ext.tml.structural.model.EnumerationLiteral;
 ...
 * 
 */	
public abstract class ACreateAddEnumerationLiteralCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		EnumerationLiteral conceptObject = new EnumerationLiteral(activeConcept);
