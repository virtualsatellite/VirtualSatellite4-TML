 ...
 * 
 */	
public abstract class AUiSnippetTableTaskDefinition extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableTaskDefinition() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddTaskDefinitionCommand().create(editingDomain, model, activeConcept);
	}
}
