 ...
 * 
 */	
public abstract class AUiSnippetSectionTaskInstance extends AUiSnippetGenericPropertyInstances implements IUiSnippet {
	public AUiSnippetSectionTaskInstance() {
		super("de.dlr.sc.virsat.model.ext.tml.structural", "TaskInstance");
	}
}
