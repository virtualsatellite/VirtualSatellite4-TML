 ...
 * 
 */	
public abstract class AAddTaskInputHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskInputCommand().create(editingDomain, owner, activeConcept);
	}
}
