 ...
 * 
 */	
public abstract class AAddTaskInputDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskInputDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
