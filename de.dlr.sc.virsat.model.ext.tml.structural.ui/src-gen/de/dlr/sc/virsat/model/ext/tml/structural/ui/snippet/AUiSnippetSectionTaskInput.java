 ...
 * 
 */	
public abstract class AUiSnippetSectionTaskInput extends AUiSnippetGenericPropertyInstances implements IUiSnippet {
	public AUiSnippetSectionTaskInput() {
		super("de.dlr.sc.virsat.model.ext.tml.structural", "TaskInput");
	}
}
