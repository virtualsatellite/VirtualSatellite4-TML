 ...
 * 
 */	
public abstract class AAddExternalTypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddExternalTypeCommand().create(editingDomain, owner, activeConcept);
	}
}
