 ...
 * 
 */	
public abstract class AUiSnippetSectionChannel extends AUiSnippetGenericPropertyInstances implements IUiSnippet {
	public AUiSnippetSectionChannel() {
		super("de.dlr.sc.virsat.model.ext.tml.structural", "Channel");
	}
}
