 ...
 * 
 */	
public abstract class AAddITypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddITypeCommand().create(editingDomain, owner, activeConcept);
	}
}
