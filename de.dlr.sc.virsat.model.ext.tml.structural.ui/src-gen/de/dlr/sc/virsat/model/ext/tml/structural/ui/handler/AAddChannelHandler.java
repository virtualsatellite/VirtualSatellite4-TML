 ...
 * 
 */	
public abstract class AAddChannelHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddChannelCommand().create(editingDomain, owner, activeConcept);
	}
}
