 ...
 * 
 */	
public abstract class AAddReferenceFrameDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddReferenceFrameDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
