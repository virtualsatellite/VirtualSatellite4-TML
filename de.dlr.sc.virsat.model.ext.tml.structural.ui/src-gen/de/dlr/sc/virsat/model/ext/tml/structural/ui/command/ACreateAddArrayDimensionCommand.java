...
import de.dlr.sc.virsat.model.ext.tml.structural.model.ArrayDimension;
 ...
 * 
 */	
public abstract class ACreateAddArrayDimensionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ArrayDimension conceptObject = new ArrayDimension(activeConcept);
