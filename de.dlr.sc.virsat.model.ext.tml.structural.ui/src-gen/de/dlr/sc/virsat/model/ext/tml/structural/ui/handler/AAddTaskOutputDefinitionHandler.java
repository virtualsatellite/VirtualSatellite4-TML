 ...
 * 
 */	
public abstract class AAddTaskOutputDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskOutputDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
