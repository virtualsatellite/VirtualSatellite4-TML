 ...
 * 
 */	
public abstract class AAddTaskInstanceHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskInstanceCommand().create(editingDomain, owner, activeConcept);
	}
}
