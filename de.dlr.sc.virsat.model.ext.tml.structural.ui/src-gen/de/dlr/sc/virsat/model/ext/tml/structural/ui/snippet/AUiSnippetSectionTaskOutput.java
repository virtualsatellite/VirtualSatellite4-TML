 ...
 * 
 */	
public abstract class AUiSnippetSectionTaskOutput extends AUiSnippetGenericPropertyInstances implements IUiSnippet {
	public AUiSnippetSectionTaskOutput() {
		super("de.dlr.sc.virsat.model.ext.tml.structural", "TaskOutput");
	}
}
