 ...
 * 
 */	
public abstract class AAddTaskDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
