 ...
 * 
 */	
public abstract class AAddTaskingEnvironmentHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskingEnvironmentCommand().create(editingDomain, owner, activeConcept);
	}
}
