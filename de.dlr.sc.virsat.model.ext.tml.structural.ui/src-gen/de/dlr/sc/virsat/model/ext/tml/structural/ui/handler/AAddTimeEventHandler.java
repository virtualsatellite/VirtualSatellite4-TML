 ...
 * 
 */	
public abstract class AAddTimeEventHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTimeEventCommand().create(editingDomain, owner, activeConcept);
	}
}
