...
import de.dlr.sc.virsat.model.ext.tml.structural.model.BasicTypeDefinition;
 ...
 * 
 */	
public abstract class ACreateAddBasicTypeDefinitionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		BasicTypeDefinition conceptObject = new BasicTypeDefinition(activeConcept);
