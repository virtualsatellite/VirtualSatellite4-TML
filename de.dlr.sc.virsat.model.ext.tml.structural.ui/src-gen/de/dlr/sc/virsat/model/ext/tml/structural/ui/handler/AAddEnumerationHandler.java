 ...
 * 
 */	
public abstract class AAddEnumerationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddEnumerationCommand().create(editingDomain, owner, activeConcept);
	}
}
