...
import de.dlr.sc.virsat.model.ext.tml.structural.model.Attribute;
 ...
 * 
 */	
public abstract class ACreateAddAttributeCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		Attribute conceptObject = new Attribute(activeConcept);
