 ...
 * 
 */	
public abstract class AAddAttributeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddAttributeCommand().create(editingDomain, owner, activeConcept);
	}
}
