 ...
 * 
 */	
public abstract class AAddBasicTypeDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddBasicTypeDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
