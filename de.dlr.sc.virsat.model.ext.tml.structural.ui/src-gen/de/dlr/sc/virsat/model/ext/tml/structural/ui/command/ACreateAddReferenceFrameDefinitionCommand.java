...
import de.dlr.sc.virsat.model.ext.tml.structural.model.ReferenceFrameDefinition;
 ...
 * 
 */	
public abstract class ACreateAddReferenceFrameDefinitionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ReferenceFrameDefinition conceptObject = new ReferenceFrameDefinition(activeConcept);
