 ...
 * 
 */	
public abstract class AAddTaskOutputHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTaskOutputCommand().create(editingDomain, owner, activeConcept);
	}
}
