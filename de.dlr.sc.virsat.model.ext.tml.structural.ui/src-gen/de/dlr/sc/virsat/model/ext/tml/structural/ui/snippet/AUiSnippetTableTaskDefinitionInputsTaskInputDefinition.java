 ...
 * 
 */	
public abstract class AUiSnippetTableTaskDefinitionInputsTaskInputDefinition extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {

	public AUiSnippetTableTaskDefinitionInputsTaskInputDefinition() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementInputsCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "TaskInputDefinition"));
	}
}
