 ...
 * 
 */	
public abstract class AUiSnippetSectionExternalType extends AUiSnippetGenericPropertyInstances implements IUiSnippet {
	public AUiSnippetSectionExternalType() {
		super("de.dlr.sc.virsat.model.ext.tml.structural", "ExternalType");
	}
}
