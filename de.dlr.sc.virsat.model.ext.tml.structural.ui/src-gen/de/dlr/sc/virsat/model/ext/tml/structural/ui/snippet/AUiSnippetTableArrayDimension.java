 ...
 * 
 */	
public abstract class AUiSnippetTableArrayDimension extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableArrayDimension() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayDimensionCommand().create(editingDomain, model, activeConcept);
	}
}
