 ...
 */
class DeclarationLangaugeIdeSetup extends DeclarationLangaugeStandaloneSetup {

	override createInjector() {
		Guice.createInjector(Modules2.mixin(new DeclarationLangaugeRuntimeModule, new DeclarationLangaugeIdeModule))
	}
