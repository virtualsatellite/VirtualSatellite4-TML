...
public abstract class ATaskOutputDefinition extends GenericCategory implements IBeanCategoryAssignment {
	...
	public ATaskOutputDefinition(Concept concept) {
		Category categoryFromActiveCategories = ActiveConceptHelper.getCategory(concept, "TaskOutputDefinition");
		CategoryAssignment categoryAssignement = new CategoryInstantiator().generateInstance(categoryFromActiveCategories, "TaskOutputDefinition");
		setTypeInstance(categoryAssignement);
	}
	
	public ATaskOutputDefinition(CategoryAssignment categoryAssignement) {
		setTypeInstance(categoryAssignement);
	}
