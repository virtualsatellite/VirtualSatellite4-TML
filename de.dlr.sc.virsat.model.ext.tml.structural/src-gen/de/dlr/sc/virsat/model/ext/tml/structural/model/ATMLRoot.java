 ...
 * 
 */	
public abstract class ATMLRoot extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.ext.tml.structural.TMLRoot";
	 ...
	 */
	public ATMLRoot(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "TMLRoot");
	 ...
	 */
	public ATMLRoot(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
